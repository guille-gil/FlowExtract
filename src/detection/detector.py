"""
Stage 1: Element Detection Module

Detects visual elements (observation boxes, decision diamonds, action boxes) 
from troubleshooting guide page images using YOLO object detection.
"""
